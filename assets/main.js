...
(function() {
	...
	// Buttons: buttons01.
		$('#buttons01 > li:nth-child(1) > a').addEventListener(
			'click',
			function(event) { 
				fbq('track', 'ViewContent', {value: 2}); return true;
			}
		);
		...
		$('#buttons01 > li:nth-child(2) > a').addEventListener(
			'click',
			function(event) { 
				fbq('track', 'ViewContent', {value: 3}); return true;
			}
		);
		
		$('#buttons01 > li:nth-child(3) > a').addEventListener(
			'click',
			function(event) { 
				fbq('track', 'ViewContent', {value: 1}); alert('Coming soon! :-)');return false;
			}
		);
